...
import { Component, Input, ViewChild, Injectable, EventEmitter, HostListener, Output } from '@angular/core';
...
class PiecePromotionModalComponent {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: PiecePromotionModalComponent, selectors: [["app-piece-promotion-modal"]], viewQuery: function PiecePromotionModalComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        } }, inputs: { pieceIconInput: "pieceIconInput", color: "color" }, decls: 6, vars: 2, consts: [["myModal", ""], [1, "container"], [1, "wrapper"], [1, "content"], ["class", "piece-wrapper", 4, "ngIf"], [1, "piece-wrapper"], [1, "piece", 3, "click"], ["alt", "Queen", 3, "src"], ["alt", "Rook", 3, "src"], ["alt", "Bishop", 3, "src"], ["alt", "Knight", 3, "src"]], template: function PiecePromotionModalComponent_Template(rf, ctx) { if (rf & 1) {
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(PiecePromotionModalComponent, { className: "PiecePromotionModalComponent", filePath: "lib/piece-promotion/piece-promotion-modal/piece-promotion-modal.component.ts", lineNumber: 12 }); })();
...
class NgxChessBoardComponent {
    ...
    static ɵfac = function NgxChessBoardComponent_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || NgxChessBoardComponent)(i0.ɵɵdirectiveInject(NgxChessBoardService)); };
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(NgxChessBoardComponent, { className: "NgxChessBoardComponent", filePath: "lib/ngx-chess-board.component.ts", lineNumber: 47 }); })();
...
export { HistoryMove, NgxChessBoardComponent, NgxChessBoardService, PiecePromotionModalComponent };
